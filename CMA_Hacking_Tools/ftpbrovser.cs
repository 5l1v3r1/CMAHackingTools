...
{
    public partial class ftpbrovser : MetroForm
    {
        public ftpbrovser()
        {
            InitializeComponent();
        ...
        private void ftpbrovser_Load(object sender, EventArgs e)
        {

            string exeyolu = Application.StartupPath + "" + "\\f\\filezilla.exe";
            ...
            SetWindowText(calistir.MainWindowHandle, "C.M.A Hacking Trasfer");
        }
    }
}
